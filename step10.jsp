...
<html>
	<head>
		<title>Wellness Java WebApp | Step 10</title>
		<meta charset="utf-8">
	...
	<body style="background-image: none;" data-page="main">
		...
		<div class="main-content">
			<div class="o-section-intro" style="background-image: url(img/bg.jpg)">
				<div class="container">
					<div class="o-section-intro__content">
						<div class="o-section-intro__jumbotron">
							<div class="o-section-intro__block-jumbotron m-block-jumbotron">
								<h2 class="m-block-jumbotron__text-title a-text-title">
									<br>YOUR DIET SUMMARY IS READY<br>
								</h2>
								<div class="m-block-jumbotron__button a-button--with-gradient a-button--gigant a-button--with-icon a-button">
									<a href="#summary" class="a-button__link">
									<span class="a-button__text">SUMMARY</span>
									</a>
								</div>
							</div>
						</div>
						<div class="o-section-intro__phone"><img src="img/head-img.png"></div>
					</div>
				</div>
			...
			<div class="o-section-summary" id="summary">
				<div class="container">
			...
			<div class="o-section-intro__block-jumbotron m-block-jumbotron text-center" style="padding: 15px;">
				<div class="m-block-jumbotron__button a-button--with-gradient a-button--gigant a-button--with-icon a-button">
					...
					<span class="a-button__text">UPDATE WEEKLY DIET</span>
					</a>
				</div>				
			</div>
		</div>
