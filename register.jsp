...
<html>
	<head>
		<title>Wellness Java WebApp | Register</title>
		<meta charset="utf-8">
	...
	<body style="background-image: none;" class="pb	pb--big" data-page="step-10">
		...
		<div class="main-content">
			<div class="o-section-head">
				...
				<div class="m-block-title__text" style="z-index: 100;">Registration Form</div>				
			</div>
			<div class="o-section-step">				
				<div class="container">
					<div class="o-section-step__form">
						<form action="processRegistration.jsp" id="register-form" class="m-form-measurments js-measurments-form dietMove measurements" data-pixel-event="User Profile" method="post" novalidate="novalidate">
								...
								<div id="tab-content-1" class="row" style="">
									<div class="field-row  col-xs-12 ">
										<div class="a-input--centered a-input--opacity-label a-input">
											<input type="text" placeholder="Name" name="name" class="a-input__input js-input" required="">
											<span class="a-input__bar"></span>
											<label class="a-input__label">Name</label>
											<div class="a-input__unit">name</div>											
										</div>
									</div>
									<div class="field-row  col-xs-12 ">
										<div class="a-input--centered a-input--opacity-label a-input">
									...
									<div class="field-row  col-xs-12 ">
										<div class="a-input--centered a-input--opacity-label a-input">
											<input type="password" placeholder="Confirm Password" name="cpass" class="a-input__input js-input" required="">
											<span class="a-input__bar"></span>
											<label class="a-input__label">Confirm Password</label>
											<div class="a-input__unit">code</div>
										</div>
									</div>
								</div>								
							...
							<div class="m-form-measurments__button a-button--with-gradient a-button--big a-button--with-icon a-button--bordered a-button">
								<button type="submit" class="a-button__link" form="register-form">
									<div class="a-button__text">Register</div>
